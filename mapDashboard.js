...
function getColor(d) { return d==01?"#C0362B" : d==02?"#E74C3C" : d==03?"#9B59B6" : d==04?"#8E44AD" : d==05?"#2980B9" : d==06?"#3498DB" : d==07?"#1ABC9C" : d==08?"#16A085":  d==09?"#27AE60": d==10?"#2ECC71": d==11?"#F1C40F": d==12?"#F39C12": d==12?"#E67E22" :"#808080" }
